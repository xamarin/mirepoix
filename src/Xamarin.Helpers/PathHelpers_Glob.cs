...
namespace Xamarin
{
    public static partial class PathHelpers
    {
        public static class Glob
        {
            ...
            sealed class TerminalEnumerator : PatternEnumerator
            {
            ...
            sealed class VerbatimEnumerator : PatternEnumerator
            {
            ...
            sealed class RecursiveDirectoryEnumerator : PatternEnumerator
            {
            ...
            sealed class GlobEnumerator : PatternEnumerator
            {
                internal static bool CanHandleWildcards (string pattern)
                    => pattern.Any (c => c == '*' || c == '?' || c == '[' || c == '{');

                public static Regex GetRegex (string pattern)
                    => new Regex (TranslatePattern (pattern), RegexOptions.Multiline);
